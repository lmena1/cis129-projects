...
quant_cakepop = int(input("Number of cake pops bought?\n"))   #\n serves to ensure the formatting depicted for this lab.
quant_scone = int(input("Number of scones bought?\n"))   #\n serves to ensure the formatting depicted for this lab.
print(stars)
print()
...
cakepop_bill = quant_cakepop * 3.00
scone_bill = quant_scone * 6.00
tax = (coffee_bill + muffin_bill + scone_bill + cakepop_bill) * 0.06
total = cakepop_bill + scone_bill + muffin_bill + coffee_bill + tax
...
print(quant_cakepop,"Cake pops at $3 each:","$",str(cakepop_bill)+"0") #+"0" is because amounts were shown with 1 decimal as opposed to 2
print(quant_scone,"Scones at $6 each:","$",str(scone_bill)+"0") #+"0" is because amounts were shown with 1 decimal as opposed to 2
print("%6 tax: $",tax)
print("---------")
print("Total: $",total,"\n"+stars)#\n appearing in print statement to reduce lines of code while ensuring specified format.
print("Thank you for being a valued customer <3 \n \nEnjoy $1 off your next purchase when you bring in this receipt!") # thank you message for customer
